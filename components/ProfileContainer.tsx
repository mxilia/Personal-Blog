  ...
  return (
    <div className="w-full h-fit p-5 pt-10 pb-0">
      <div className="flex gap-2 justify-evenly items-center mb-5">
        <img className="w-17 h-17 border-2 border-neutral-300 rounded-[50px] object-cover" src="/cat.jpg"></img>
      ...
      <div>
        ...
        If you wish to know more about me, you can checkout my <a className="text-blue-400" href="https://symoney.vercel.app/" target="_blank">portfolio website</a>.
      </div>
    </div>
  )
}

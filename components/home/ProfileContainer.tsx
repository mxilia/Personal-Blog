  ...
  return (
    <div className="h-fit p-5 pt-10 pb-0">
      <div className="flex gap-2 items-center mb-5">
        <Image alt="img not available" width={48} height={48} className="border-2 border-[var(--sub-text2)] rounded-[50px] object-cover" src="/kuromi.jpg"/>
        <span className="flex flex-1 border-2 border-[var(--border-block)] p-2 rounded-2xl text-xs font-[monospace] text-[var(--text)]">
